...
files = scene.cpp box.cpp texture_loader.cpp sun.cpp moon.cpp roof.cpp ribs.cpp dustbin.cpp roundChair.cpp plant.cpp cafeCounter.cpp coffeeMachine.cpp textured_mesh.cpp
